#!/usr/bin/env python3
"""
Orchestra Test: SP beep beep beep + EV3 woof woof woof
------------------------------------------------------
...
async def test_parallel():
    ...
    """
    print("=" * 60)
    print("ORCHESTRA TEST: Parallel SP beep + EV3 woof")
    print("=" * 60)
...
async def test_synchronized():
    ...
    """
    print("=" * 60)
    print("ORCHESTRA TEST: 3 Rounds of Synchronized beep + woof")
    print("=" * 60)
...
async def test_sequential():
    ...
    """
    print("=" * 60)
    print("ORCHESTRA TEST: REAL Collaboration (1 melody!)")
    print("=" * 60)
...
async def main():
    parser = argparse.ArgumentParser(description="Orchestra beep/woof test")
